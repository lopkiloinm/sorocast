...
export interface Client {
   ...
   */
  set_outcome: ({market, outcome}: {market: string, outcome: u32}, options?: {
    /**
   ...
   */
  get_outcome: ({market}: {market: string}, options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAALc2V0X291dGNvbWUAAAAAAgAAAAAAAAAGbWFya2V0AAAAAAATAAAAAAAAAAdvdXRjb21lAAAAAAQAAAAA",
        "AAAAAAAAAAAAAAALZ2V0X291dGNvbWUAAAAAAQAAAAAAAAAGbWFya2V0AAAAAAATAAAAAQAAA+gAAAAE" ]),
      options
    )
  }
  public readonly fromJSON = {
    set_outcome: this.txFromJSON<null>,
        get_outcome: this.txFromJSON<Option<u32>>
  }
}